...
region = Region.rectangle(400, 400, 32, 32)
...
x = np.arange(0.01, 400, 10)
y = np.arange(0.01, 400, 10)
...
boundary_solution = solver.solve_boundary(Orientation.Interior, k*0.8, c*.95, bc, bi)
...
region.plot(ax3)
ex = np.arange(-300, 800, 10)
ey = np.arange(-300, 800, 10)
